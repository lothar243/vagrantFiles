...
ldapsearch -H ldap://dc.$domain -D jane.doe@$domain -w Pa55w.rd -x -LLL -b CN=Users,$domainDn '(&(objectClass=person)(!(userAccountControl:1.2.840.113556.1.4.803:=2)))' sAMAccountName userPrincipalName userAccountControl displayName cn mail
ldapsearch -H ldaps://dc.$domain -D jane.doe@$domain -w Pa55w.rd -x -LLL -b CN=Users,$domainDn '(&(objectClass=person)(!(userAccountControl:1.2.840.113556.1.4.803:=2)))' sAMAccountName userPrincipalName userAccountControl displayName cn mail
EOF
